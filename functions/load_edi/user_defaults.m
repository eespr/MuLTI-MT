...
u.rholim = [10^0 10^5]; %Apparent resistivity limits for off-diagonals
%u.rholimdiag = u.rholim;
u.rholimdiag = [10^-1 10^3]; %Apparent resistivity limits for diagonals
...
u.pt_pseudo_scale = 1; %Scaling for phase tensor pseudo sections (usually 1 is ok as default; >1 makes them bigger)
